...
like1 = Like.create!({user_id: user4.id, post_id: 6})
like2 = Like.create!({user_id: 3, post_id: 6})
like3 = Like.create!({user_id: user4.id, post_id: 7})
like4 = Like.create!({user_id: user4.id, post_id: 8})
like5 = Like.create!({user_id: user4.id, post_id: 9})
like6 = Like.create!({user_id: user4.id, post_id: 10})

comment1 = Comment.create!({body: "That's awesome", user_id: 4, post_id: 6})
comment2 = Comment.create!({body: "That's cool", user_id: 3, post_id: 6})
comment3 = Comment.create!({body: "That's amazing", user_id: 4, post_id: 7})
comment4 = Comment.create!({body: "That's interesting", user_id: 4, post_id: 8})
comment5 = Comment.create!({body: "That's beautiful", user_id: 4, post_id: 9})
comment6 = Comment.create!({body: "That's great", user_id: 4, post_id: 10})

following1 = Following.create!({follower_id: 4, following_id: user1.id})
following2 = Following.create!({follower_id: 2, following_id: 6})
following3 = Following.create!({follower_id: 4, following_id: 4})
following4 = Following.create!({follower_id: 5, following_id: 3})
following5 = Following.create!({follower_id: 3, following_id: 1})
following6 = Following.create!({follower_id: 4, following_id: 2})
following7 = Following.create!({follower_id: 6, following_id: 2})
